...
class ProduitCommandeService:
    def __init__(self):
        self.dao = ProduitCommandeDao()

    def find_by_id(self, id_commande, id_produit):
        """
        Tries to find an entity using its Id / Primary Key
        :param id_commande, id_produit: PK of the entity to find
        :return: False if entity not found, entity if found
        """
        return self.dao.find_by_id(id_commande, id_produit)
    ...
    def delete_by_id(self, id_commande, id_produit):
        ...
        :param id_commande, id_produit: PK of the entity to delete
        :return: true if the entity has been deleted, false if not found and not deleted
        """
        return self.dao.delete_by_id(id_commande, id_produit)
    ...
    def exists_by_id(self, id_commande, id_produit):
        ...
        :param id_commande, id_produit: PK to check in database
        :return: true or false
        """
        return self.dao.exists_by_id(id_commande, id_produit)
